...
#SBATCH --job-name=no_precondition_3d_fiber_ox
#SBATCH --nodes=24
...
OUTPUT=/blue/michael.tonks/robtclay/bigprojects/macawupdated/examples/3d_woven_fiber_ox/noPrecondition_step2/
...
cd $OUTPUT
srun --mpi=pmix_v5 $MOOSE -i $OUTPUT/noPrecondition_step2_multi.i