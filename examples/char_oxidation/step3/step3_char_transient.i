...
[]
  ...
  #------------------------------------------------------------------------------#
[UserObjects]
    [solution_uo_step1] # Transfer the thermal conductivity tensor
      type = SolutionUserObject
      mesh = ../step1/step1_char_out.e
      system_variables = 'var_00 var_01 var_02
...
#------------------------------------------------------------------------------#
[Outputs]
    file_base = ./results/step3_char_out
