...
OUTPUT=/blue/michael.tonks/robtclay/bigprojects/macawupdated/examples/woven_fiber_oxidation_2d/perf_step2/adapt_interval/interval1
...
cd $OUTPUT
srun --mpi=pmix_v5 $MOOSE -i $OUTPUT/step2_multi_interval1.i