...
#SBATCH --job-name=2d_fiber_ox_adaptmaxh0
...
OUTPUT=/blue/michael.tonks/robtclay/bigprojects/macawupdated/examples/woven_fiber_oxidation_2d/perf_step2/adapt_maxh/maxh0
...
cd $OUTPUT
srun --mpi=pmix_v5 $MOOSE -i $OUTPUT/step2_multi_maxh0.i