...
#SBATCH --job-name=2d_fiber_ox_adaptmaxh2
...
OUTPUT=/blue/michael.tonks/robtclay/bigprojects/macawupdated/examples/woven_fiber_oxidation_2d/perf_step2/adapt_maxh/maxh2
...
cd $OUTPUT
srun --mpi=pmix_v5 $MOOSE -i $OUTPUT/step2_multi_maxh2.i