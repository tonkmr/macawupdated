...
#SBATCH --job-name=2d_fiber_ox_3micron
...
OUTPUT=/blue/michael.tonks/robtclay/bigprojects/macawupdated/examples/woven_fiber_oxidation_2d/perf_step2/intwidth/3micron/
...
cd $OUTPUT
srun --mpi=pmix_v5 $MOOSE -i $OUTPUT/step2_multi_3micron.i